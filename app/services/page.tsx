      ...
      <main className="flex-1 p-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden mb-8">
            <div className="px-6 py-4 bg-gradient-to-r from-pink-500 to-pink-600 border-b">
            ...
            <form onSubmit={handleSubmit} className="p-6">
              ...
              <div className="flex flex-col sm:flex-row sm:justify-between gap-3">
                <div className="flex gap-3">
                  ...
                  {editingServiceId && (
                    <button 
                      type="button" 
                      onClick={cancelEdit}
                      className="px-6 py-3 bg-gray-200 text-gray-800 rounded-md hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-all font-medium flex items-center justify-center"
                      disabled={isSubmitting}
                    >
                      <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <button 
                  ...
                  className="px-4 py-2 text-gray-600 hover:text-gray-800 flex items-center justify-center focus:outline-none text-sm font-medium"
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            <div className="px-6 py-4 bg-gradient-to-r from-purple-500 to-indigo-600 border-b flex justify-between items-center">
              <h2 className="text-xl font-semibold text-white">
                Your Services
              </h2>
              <div className="relative">
                <input
                  ...
                  className="w-48 sm:w-64 pl-10 pr-4 py-2 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-indigo-600"
                />
            ...
            {loading ? (
              <div className="flex items-center justify-center h-64">
                <div className="flex flex-col items-center space-y-4">
                  <div className="w-12 h-12 border-4 border-gray-200 border-t-4 border-t-indigo-500 rounded-full animate-spin"></div>
              ...
              <div className="flex flex-col items-center justify-center h-64 p-6 text-center">
                {searchTerm ? (
                  <>
                    ...
                    <h3 className="text-lg font-medium text-gray-900 mb-1">No matching services</h3>
                  ...
                  <>
                    ...
                    <p className="text-gray-500 mb-4">Create your first service using the form above</p>
                  </>
                )}
              </div>
            ) : (
                  ...
                  <tbody className="divide-y divide-gray-200">
                    {filteredServices.map((service) => (
                      <tr key={service.id} className="hover:bg-gray-50 transition">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-gray-900 font-medium">RM {service.price.toFixed(2)}</div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
